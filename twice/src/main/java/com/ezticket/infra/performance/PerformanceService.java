...
//	결제 취소 좌석 정보 ny변경
    ...
    static final String admin_Key = "20b0d4eeab076cff4344136c30e210bb"; // 공개 조심! 본인 애플리케이션의 어드민 키를 넣어주세요
    private PerformanceDto kakaoReady;
    
    public PerformanceDto kakaoPayReady() {
       ...
       parameters.add("total_amount", "2222");
       parameters.add("tax_free_amount", "22");
